...
let marksObt = 756;
let totalMarks = 850;
let percentage = Math.floor(marksObt / totalMarks * 100);
console.log(`Percentage Marks : ${percentage} %`);
//Function method
function calculatePercentage(num1, percent) {
    var percentage = num1 * percent / 100;
    console.log(`${percent}% of ${num1} is : ${percentage}%`);
}
calculatePercentage(1066, 20);
//Arrow method =>
let calculatePr = (num2, pr) => {
    var per = num2 * pr / 100;
...
//Function method
function calculateDiscount(num2, discount) {
    if (num2 > 100) {
        discount = 10;
    }
    else {
    ...
    var disc = num2 * discount / 100;
    console.log(`${discount}% Discount on $${num2} is : $${disc}`);
}
calculateDiscount(100);
//Arrow method
let dis_count = (num2, discount) => {
    if (num2 > 100) {
        discount = 10;
    }
    else {
...
function calculate_Discount(num2, discount) {
    switch (true) {
        case (num2 > 100):
            discount = 10;
            break;
